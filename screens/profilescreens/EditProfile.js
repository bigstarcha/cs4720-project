...
const EditProfile = ({ route, navigation }) => {
    const {epronoun, eposition, efirstPromptQuestion, esecondPromptQuestion} = route.params;
    ...
    const [firstPromptQuestion, setFirstPromptQuestion] = useState(efirstPromptQuestion); // First prompt question
    const [secondPromptQuestion, setSecondPromptQuestion] = useState(esecondPromptQuestion); // Second prompt question
    ...
    const editProfile = () => {
        ...
        if (name == '' || dob == '' || pronoun == '' || position == '' || company == '' || firstPromptQuestion == '' || firstPromptAnswer == '' || image == null || secondPromptQuestion == '' || secondPromptAnswer == '') {
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View>
                    ...
                    <SelectList 
                        ...
                        search={false}
                        save="value"
                        defaultOption={firstPromptQuestions[getKeyByValue(firstPromptQuestions, efirstPromptQuestion)]}
                    />
                    ...
                    <SelectList
                        ...
                        search={false}
                        save="value"
                        defaultOption={secondPromptQuestions[getKeyByValue(secondPromptQuestions, esecondPromptQuestion)]}
                    />
